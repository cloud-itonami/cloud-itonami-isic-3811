# Operator Quickstart — cloud-itonami-isic-3811

Shortest path from clone to a verified local dry-run for **ISIC 3811** (`cloud-itonami-isic-3811`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-3811.git
